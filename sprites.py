...
class Player(pygame.sprite.Sprite):
    ...
    def movement(self):
        ...
        if keys[pygame.K_LEFT]:
            ...
            if not self.would_collide(temp_rect):
    ...
    def would_collide(self, rect):
        #Check if moving to this position would cause a collision with blocks
        # Create a temporary sprite to check collisions
        temp_sprite = pygame.sprite.Sprite()
        temp_sprite.rect = rect

        # Check for collisions with blocks
        return pygame.sprite.spritecollide(temp_sprite, self.game.blocks, False)
    ...
    def animate(self):
        ...
        left_animations = [
            self.game.character_spritesheet.get_sprite(3, 98, self.width, self.height),  # FIXED: get_sprite not getsprite
